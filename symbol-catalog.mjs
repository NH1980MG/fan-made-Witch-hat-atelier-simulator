...
export const SYMBOL_PATHS = Object.freeze({
  ...
  Epee: paths(
    "M18 7 C18 17 18 24 24 28 C30 32 31 37 31 43",
    "M30 7 C30 17 28 22 24 28 C20 34 19 38 19 43",
  ),
  "Loup-ecaille": paths(
  ...
  "Chevre-lion": paths(
    "M8 13 L12 9 L17 14 M40 13 L36 9 L31 14 M11 25 C13 14 35 14 37 25 C38 33 32 38 24 38 C16 38 10 33 11 25 Z",
    "M12 25 L5 25 M36 25 H43 M24 17 L18 36 M24 17 L30 36 M18 39 C21 44 27 44 30 39",
    "M7 28 L5 33 M41 28 L43 33 M19 45 H29",
  ),
  "Chat-hibou": paths(
  ...
  "Tete de chat-hibou": paths(
    circle(24, 24, 12),
    "M17 13 L13 5 M31 13 L35 5 M24 14 L19 27 M24 14 L29 27",
    "M12 23 L6 20 L4 29 M36 23 L42 20 L44 29",
  ),
  Dragon: paths(
    "M5 27 C6 18 14 17 18 22 C22 14 30 13 34 20 C38 20 42 23 43 29",
    "M14 25 L22 18 L30 28 L37 23 L43 32 L35 29 L32 39 L27 29 L17 33 L11 29",
    "M19 17 L15 12 M24 17 L20 9 M29 17 L26 10",
  ),
  Fleur: paths(
  ...
  "Oiseau A": paths(
    "M4 25 C9 14 14 13 19 20 C22 15 26 15 29 20 C34 13 39 14 44 25",
    "M8 21 L4 16 M11 19 L8 13 M40 21 L44 16 M37 19 L40 13",
  ),
  "Oiseau B": paths(
  ...
  "Arret temporel": paths(
    ...
    circle(24, 24, 8),
    circle(24, 24, 2.3),
    "M24 5 V16 M24 32 V43 M5 24 H16 M32 24 H43 M11 11 L18 18 M30 30 L37 37 M37 11 L30 18 M18 30 L11 37",
  ),
